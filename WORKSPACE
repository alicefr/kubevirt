...
rpm(
    ...
    urls = [
        ...
        "https://ftp.plusline.net/fedora/linux/releases/32/Everything/aarch64/os/Packages/g/genisoimage-1.1.11-44.fc32.aarch64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://ftp-stud.hs-esslingen.de/pub/fedora/linux/updates/32/Everything/x86_64/Packages/k/kernel-debug-core-5.11.22-100.fc32.x86_64.rpm",
        ...
        "https://mirrors.xtom.de/fedora/updates/32/Everything/x86_64/Packages/k/kernel-debug-core-5.11.22-100.fc32.x86_64.rpm",
...
rpm(
    ...
    urls = [
        ...
        "https://ftp.plusline.net/fedora/linux/releases/32/Everything/aarch64/os/Packages/l/libusal-1.1.11-44.fc32.aarch64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://ftp-stud.hs-esslingen.de/pub/fedora/linux/updates/32/Everything/x86_64/Packages/s/selinux-policy-minimum-3.14.5-46.fc32.noarch.rpm",
        ...
        "https://mirror.dogado.de/fedora/linux/updates/32/Everything/x86_64/Packages/s/selinux-policy-minimum-3.14.5-46.fc32.noarch.rpm",
    ],
)
