...
func (app *virtHandlerApp) Run() {
	...
	var relabelPaths []*safepath.Path
	...
	if err == nil && exists {
		...
		relabelPaths = append(relabelPaths, devTun, devNull)
		err = selinux.RelabelFiles(unprivilegedContainerSELinuxLabel, se.IsPermissive(), relabelPaths...)
		if err != nil {
