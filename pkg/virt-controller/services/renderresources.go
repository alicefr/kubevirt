...
func doesVMIRequireCPUForIOThreads(vmi *v1.VirtualMachineInstance) bool {
	return vmi.Spec.Domain.IOThreads != nil &&
		vmi.Spec.Domain.IOThreads.Policy == v1.IOThreadsPolicyDedicated &&
		vmi.Spec.Domain.IOThreads.Count != nil &&
		*vmi.Spec.Domain.IOThreads.Count > 0
}
...
func WithIOThreads(iothreads *v1.DiskIOThreads) ResourceRendererOption {
	return func(renderer *ResourceRenderer) {
		if iothreads == nil || iothreads.Count == nil || *iothreads.Count < 1 {
			return
		}
