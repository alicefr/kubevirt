...
func addBlockPVCToContainer(c *k8sv1.Container, volumeName string, claimName string) {
...
func addFsPVCToContainer(c *k8sv1.Container, volumeName string, claimName string) {
...
func removeBlockPVCToContainer(c *k8sv1.Container, volumeName string) {
...
func removeFsPVCToContainer(c *k8sv1.Container, volumeName string) {
...
func adjustContainerVolume(c *k8sv1.Container, volName, src string, info *volInfo) {
	...
	case k8sv1.PersistentVolumeFilesystem:
		addBlockPVCToContainer(c, volName, info.destPVC)
		removeFsPVCToContainer(c, volName)
	case k8sv1.PersistentVolumeBlock:
		addFsPVCToContainer(c, volName, info.destPVC)
		removeBlockPVCToContainer(c, volName)
	}
}
