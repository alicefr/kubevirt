	...
	for _, v := range migVols {
		vmi.Status.MigratedVolumes = append(vmi.Status.MigratedVolumes,
			virtv1.StorageMigratedVolumeInfo{
				VolumeName:         v.SourcePvc,
				SourcePVCInfo:      &virtv1.PersistentVolumeClaimInfo{ClaimName: v.SourcePvc},
				DestinationPVCInfo: &virtv1.PersistentVolumeClaimInfo{ClaimName: v.DestinationPvc},
