...
func PatchTestReplaceAnnotations(initialAnnotations, desiredAnnotations map[string]string) ([]byte, error) {
	patches := New()
...
func PatchTestReplaceLabels(initialLabels, desiredLabels map[string]string) ([]byte, error) {
	patches := New()
...
func PatchTestReplaceFinalizers(oldFinalizers, newFinalizers []string) ([]byte, error) {
	patches := New()
...
func PatchTestReplaceConditions(oldConditions, newConditions interface{}) ([]byte, error) {
	patches := New()
