...
const (
	...
	IOThreadsPolicyDedicated IOThreadsPolicy = "dedicated"
...
type DiskIOThreads struct {
	...
	// +optional
	Policy IOThreadsPolicy `json:"policy,omitempty"`
	// Count specifies how many iothreads are allocated for the dedicated policy.
	// +optional
