...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ActivePod) DeepCopyInto(out *ActivePod) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActivePod.
func (in *ActivePod) DeepCopy() *ActivePod {
	if in == nil {
		return nil
	}
	out := new(ActivePod)
...
func (in *VirtualMachineInstanceMigrationSpec) DeepCopyInto(out *VirtualMachineInstanceMigrationSpec) {
	*out = *in
	if in.MigrationSchedulingPerference != nil {
		in, out := &in.MigrationSchedulingPerference, &out.MigrationSchedulingPerference
		*out = new(MigrationSchedulingPerference)
		**out = **in
	}
	return
}
...
func (in *VirtualMachineInstanceStatus) DeepCopyInto(out *VirtualMachineInstanceStatus) {
	*out = *in
	...
	if in.ActivePods != nil {
		...
		*out = make(map[types.UID]ActivePod, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
