...
// SourcePvcReclaimPolicy describes how the source PVC will be treated after the storage migration completes.
// The policies follows the same behavior as the RetainPolicy for PVs:
//
//	https://kubernetes.io/docs/concepts/storage/persistent-volumes/#reclaiming
type SourcePvcReclaimPolicy string

const (
	SourcePvcReclaimPolicyDelete SourcePvcReclaimPolicy = "Delete"
	SourcePvcReclaimPolicyRetain SourcePvcReclaimPolicy = "Retain"
)

type MigratedVolume struct {
	SourcePvc              string                 `json:"sourcePvc" valid:"required"`
	DestinationPvc         string                 `json:"destinationPvc" valid:"required"`
	SourcePvcReclaimPolicy SourcePvcReclaimPolicy `json:"sourcePvcReclaimPolicy,omitempty"`
}
...
const (
	...
	ReasonRejectedMultipleVMIs           = "Volumes needs to belong to the same VMI"
	ReasonRejectedPending                = "Volumes needs to belong to a running VMI"
	ReasonRejectedMultipleVMIsAndPending = "Volumes needs to belong to the same running VMI"
)
...
type MigratedVolumeState string

const (
	MigratedVolumeStateValid    MigratedVolumeState = "Valid"
	MigratedVolumeStatePending  MigratedVolumeState = "Pending"
	MigratedVolumeStateRejected MigratedVolumeState = "Rejected"
)
...
type VolumeMigrationState struct {
	...
	State          MigratedVolumeState `json:"state,omitempty"`
